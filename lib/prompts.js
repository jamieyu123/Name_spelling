...
When the reply is in Spanish and you spell a name letter-by-letter for TTS, use the letter names in this table—never English or NATO names. Separate letter names with commas in the written reply only; never say the word "coma" aloud or treat it as part of the spelling—it is punctuation, not a letter. Do not use hyphens between letters.
